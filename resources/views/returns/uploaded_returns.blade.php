    ...
    <!-- end page title -->  --}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 card-box">
                        ...
                        <h3 class="text-success">History of Uploaded files</h3>
                        <hr>
                                        ...
                                        @foreach ($uploaded_returns as $return)
                                            ...
                                            <th scope="col" class="text-center">
                                                <a href="#" class="view_details"  data-value="{{ json_encode($return) }}" data-toggle="modal"
                                                    ...
                                                    {{ $return->return_name }} {{ $return->revision_id }}
                                                </a>

                                            </th>
                                            <th scope="col" class="text-center">{{ $return->return_reference }}</th>
                                            <th scope="col" class="text-center">{{ $return->revision_id }}</th>
                                            <th scope="col" class="text-center">{{ $return->return_type_id }}</th>
